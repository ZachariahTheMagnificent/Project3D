...
float Vector3::GetAngleBetween(const Vector3& vector) const
{
	return acos(Dot(vector)/(Length()*vector.Length()));
}
...
/*!
\brief
operator*= overload for scalar dibvision and assignment
